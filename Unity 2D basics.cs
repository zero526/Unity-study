...
/* 부드럽게 플레이어를 따라 움직이는 카메라 스크립트 작성시 도트 그래픽이 뭉개져 보일수 있음. //아직 해결못함
void LateUpdate()
{
...
//씬 전환은 큰 화면에 다 그려넣고 화면만 이동하는 경우와
//아예 다른 씬으로 옮겨가는 경우가 있다 ( 로딩 발생 )


#if UNITY_EDITOR
//에디터에서만 실행되고 빌드에서는 포함되지 않는 코드의 맨 위에 추가
